...
import logoXorsafe from '@/images/logos/workexp/xorsafe-logo.png';
import logoJiit from '@/images/logos/workexp/jiit-logo.png';
...
function Photos() {
  ...
  return (
    <div className="mt-16 sm:mt-20 sm:px-4 px-2">
      <div className="-my-4 flex justify-start gap-5 overflow-y-auto py-4 sm:gap-8 snap-x snap-mandatory">
        {[image1, image2, image3, image4, image5].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
              'relative snap-always snap-center aspect-[9/10] w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 sm:w-72 sm:rounded-2xl dark:bg-zinc-800',
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            ...
            /> */}
            <SocialLink
              href="https://github.com/nikhilnxvverma1"
